...
export const projects: Project[] = [
    {
        ...
        shortDescription: "Take us wherever you go so that you know what's going",
        category: 'Web Design',
        ...
        architecture: 'This project implements a modern frontend architecture using React and Next.js for server-side rendering and optimal performance. We leverage TypeScript for type safety and improved developer experience.',
        implementationChallenges: 'One of the main challenges was implementing a responsive design that works seamlessly across all devices while maintaining excellent performance. We solved this by using a combination of Tailwind CSS and custom optimizations.',
...
const ProjectCard = ({ project }) => {
  return (
    ...
    },
    {
        ...
        architecture: 'Our design system is built with a component-first approach, ensuring consistency across all platforms. We use Storybook for documentation and testing, with a modular structure that allows for easy updates and maintenance.',
        implementationChallenges: 'Creating a system that works across multiple products while maintaining flexibility for individual project needs was challenging. We implemented a token-based approach that allows for theme customization while preserving the core design language.'
    },
    {
        id: 'react-libraries',
        ...
        shortDescription: "Take us wherever you go so that you know what's going on with your money at all times.",
        category: 'Dashboard',
        ...
        architecture: 'This project showcases modern React patterns including hooks, context, and efficient rendering strategies. We\'ve implemented a custom state management solution that combines Redux for global state with Context API for component-specific state.',
        implementationChallenges: 'Managing performance with complex data visualization components was challenging. We implemented virtualization and memoization techniques to ensure smooth performance even with large datasets.'
    },
    {
        ...
        architecture: 'Our illustration system is built on a grid-based framework that ensures consistency while allowing for creative expression. We\'ve developed a custom color palette and style guide that maintains brand identity across all assets.',
        implementationChallenges: 'Creating illustrations that work across different platforms and contexts required careful planning. We developed a modular approach that allows illustrations to be adapted for various use cases while maintaining visual consistency.'
    },
    {
        id: 'icons-formed',
        ...
        architecture: 'Our icon system is built on a 24x24 grid that scales proportionally to different sizes. We\'ve implemented a naming convention and organization system that makes it easy to find and use icons across the application.',
        implementationChallenges: 'Ensuring visual consistency across hundreds of icons required establishing clear guidelines and review processes. We created a specialized QA workflow to verify that all icons adhere to our design principles.'
    }
];